  ...
  <div class="main_container">
            	...
            	<div id="myCarousel" class="carousel slide" data-ride="carousel">
					  ...
					  <div class="carousel-inner">
					    <div class="item active">
					      <img src="/resources/img/1.jpg" alt="1" style="width:100%;height:100px">
					    </div>
					
					    <div class="item">
					      <img src="/resources/img/2.jpg" alt="2" style="width:100%;height:100px">
					    </div>
					
					    <div class="item">
					      <img src="/resources/img/3.jpg" alt="3" style="width:100%;height:100px">
					    </div>
					  </div>
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="dashboard_graph">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                  <div id="map" class="demo-placeholder" style="height:800px">
                  </div>
                </div>
        ...
        <footer>
          <div class="pull-right">
            	네이버 지도  BY <a href="https://colorlib.com">동림 P&D</a>
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
...
<script src="/resources/vendors/jquery-2.2.3/dist/jquery.min.js"></script>
 <!-- Bootstrap -->
